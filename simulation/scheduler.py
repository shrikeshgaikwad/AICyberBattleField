"""
Simulation Scheduler - Red vs Blue Round Manager
==================================================
Manages attack-defense simulation rounds.
"""
...
class SimulationScheduler:
    """
    Manages Red vs Blue simulation rounds.
    Each round: Red Team attacks → Blue Team defends → Score both.
    """
    ...
    def run_simulation(self, simulation_id: str) -> SimulationConfig:
        """
        ...
        try:
            for round_num in range(1, sim.max_rounds + 1):
                ...
                round_result = self._run_round(sim, round_num, target_ip, red_agent, blue_agent)
    ...
    def _score_blue_team(self, round_obj: SimulationRound) -> float:
        ...
        # Points for detecting attacks
        score += round_obj.blue_team_detections * 15

        # Points for blocking attacks
        score += round_obj.blue_team_blocks * 20

        # Points for preventing successful exploits
        ...
        # Penalty for missed attacks (exploits that succeeded undetected)
